    ...
    <>
      {
        ...
        </div> : <div className={isEmpty(menuList) || categoryError ? "pointer-events-none select-none" : "min-h-screen bg-gray-50 relative pb-20"}> {/* pb-20 ensures content isn't hidden behind fixed cart */}
        {/* Sticky Header */}
