...
const OwnerMainRestaurantItem = ({ name, address, category, movePath, del }: itemProps) => {
    ...
    <div onClick={() => movePath()} className="bg-white rounded-xl border border-gray-200 p-5 flex items-center justify-between hover:shadow-md transition-shadow cursor-pointer group">
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-gray-400 text-xs">카테고리: {category}개</p>
        </div>
      </div>
      {/* Action Icons */}
      <div className="flex items-center gap-4">
        <button onClick={handleDeleteClick} className="text-gray-400 hover:text-red-500 p-2 rounded-full hover:bg-red-50 transition-colors">
...
export default OwnerMainRestaurantItem;